...
const ChatBotAdmin = ({ isOpen, onClose }: ChatBotAdminProps) => {
    ...
    const handleSave = () => {
        ...
        localStorage.setItem('MANDELBROT_TEMPERATURE', String(config.temperature));
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-32 bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:border-purple-500 focus:outline-none resize-none placeholder-slate-700"
                                        />
                                    </div>
                                </div>
